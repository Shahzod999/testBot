  ...
  return (
    <div className="contacts">
      ...
      <div className="contacts__actions">
        <ContactsActions text="Скачать приложение" icon={<TbAppsFilled />} />
        <ContactsActions text="Telegram, WhatsApp" icon={<TbMessageChatbotFilled />} />
        <ContactsActions text="+998 99 001 23 45" icon={<IoCall />} />
        <ContactsActions text="chaykof.uz" icon={<IoEarth />} />
        <ContactsActions text="Открыто до 22:00" icon={<GoClockFill />} />
        <ContactsActions text="Улица Махатма Ганди, Ц-1" icon={<IoNavigateCircle />} />
        <ContactsActions text="Доступные вакансии (2)" icon={<FaAddressCard />} />
      </div>
    </div>
  );
};
